...
if 'Histogram' in plot_type:
  ...
  hist_features = st.sidebar.selectbox("Select the column to create histogram:", 
                                            ('RI', 'Na', 'Mg', 'Al', 'Si', 'K', 'Ca', 'Ba', 'Fe'))
# Create histograms.
...
if 'Box Plot' in plot_type:
  ...
  columns = st.sidebar.selectbox("Select the column to create Box Plot:", 
                                            ('RI', 'Na', 'Mg', 'Al', 'Si', 'K', 'Ca', 'Ba', 'Fe'))
...
if classifier == 'Logistic Regression':
    ...
    max_iter_input = st.sidebar.slider("Maximum iteration", 10, 1000, step = 10)
